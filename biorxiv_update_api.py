...
# The YAML file "config_mss.yaml" must include configuration for biorxiv_config and medrxiv_config.
...
# For each source the aggregated data is stored in the "data_folder"
...
if __name__ == "__main__":
    ...
    # Get the last check date from all files in the data_folder.
    ...
    if unprocessed_files_bio:
        ...
        #     upload_path(path, "//") # not required for own server
    else:
